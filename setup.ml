...
(* OASIS_START *)
(* DO NOT EDIT (digest: d82ab2035fab42e6f1f0e6c64dfad572) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$osilo_tests", []))];
     ...
     package =
       {
          ...
          homepage = Some "https://www.github.com/m-harrison/osilo";
          bugreports = None;
          synopsis = "Peer to peer secure sharing of personal data";
          description =
            Some
              [OASISText.Para "Peer to peer secure sharing of personal data"];
          tags = [];
          categories = [];
          files_ab = [];
          sections =
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("datakit-client", None);
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "server";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "osilo"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
                   ...
                   {exec_custom = false; exec_main_is = "Osilo_server.ml"});
               Executable
                 ({
                     cs_name = "client";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "Osilo_client.ml"});
               Executable
                 ({
                     cs_name = "osilo_tests";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "test_src.ml"});
               Test
                 ({
                     cs_name = "osilo_tests";
                     cs_data = PropList.Data.create ();
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for osilo library stack";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.7";
     oasis_digest = Some "\176\227\186\246Um\143\136p\145\182\235\222}\236y";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
